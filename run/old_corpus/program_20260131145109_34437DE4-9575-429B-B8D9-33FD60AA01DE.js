try {
    ...
    let v11;
    try {
        v11 = makeField(kWasmI64, true);
    } catch(e19) {
    }
    let v14;
    try {
        v14 = makeField(kWasmI32, false);
    } catch(e26) {
    }
    let v17;
    try {
        v17 = wasmRefNullType(kWasmNullExternRef);
    } catch(e32) {
    }
    let v19;
    try {
    ...
    let v24;
    try {
        v24 = makeField(kWasmI64, true);
    } catch(e51) {
    }
    let v26;
    try {
        v26 = makeField(kWasmI32, false);
    } catch(e58) {
    }
    let v27;
    try {
        v27 = wasmRefNullType(kWasmNullExternRef);
    } catch(e64) {
    }
    let v29;
    try {
        v29 = makeField(v27, true);
    } catch(e70) {
    }
    let v31;
    try {
        v31 = wasmRefNullType(kWasmNullFuncRef);
    } catch(e76) {
    }
    let v33;
    try {
        v33 = makeField(v31, false);
    } catch(e82) {
    }
    const v34 = [v24,v26,v29,v33];
    try {
        builder.addStruct(v34, 0);
    } catch(e87) {
    }
    try {
        builder.endRecGroup();
    ...
    let v39;
    try {
        v39 = wasmRefNullType(2);
    } catch(e95) {
    }
    let v41;
    try {
        v41 = makeField(v39, false);
    } catch(e101) {
    }
    let v44;
    try {
        v44 = wasmRefType(kWasmI31Ref);
    } catch(e107) {
    }
    let v46;
    try {
        v46 = makeField(v44, false);
    } catch(e113) {
    }
    let v48;
    try {
        v48 = makeField(kWasmI32, false);
    } catch(e120) {
    }
    let v50;
    try {
        v50 = wasmRefNullType(kWasmArrayRef);
    } catch(e126) {
    }
    let v52;
    try {
        v52 = makeField(v50, false);
    } catch(e132) {
    }
    const v53 = [v41,v46,v48,v52];
    try {
        builder.addStruct(v53);
    } catch(e136) {
    }
    try {
        builder.startRecGroup();
    ...
    let v57;
    try {
        v57 = wasmRefNullType(2);
    } catch(e144) {
    }
    let v59;
    try {
        v59 = makeField(v57, false);
    } catch(e150) {
    }
    let v60;
    try {
    ...
    let v62;
    try {
        v62 = makeField(v60, false);
    } catch(e162) {
    }
    let v64;
    try {
        v64 = makeField(kWasmI32, false);
    } catch(e169) {
    }
    let v65;
    try {
        v65 = wasmRefNullType(kWasmArrayRef);
    } catch(e175) {
    }
    let v67;
    try {
        v67 = makeField(v65, false);
    } catch(e181) {
    }
    const v68 = [v59,v62,v64,v67];
    try {
        builder.addStruct(v68, 2);
    } catch(e186) {
    }
    try {
        builder.endRecGroup();
    ...
    let v92;
    try {
        v92 = wasmRefNullType(kWasmNullFuncRef);
    } catch(e237) {
    }
    let v95;
    try {
        v95 = wasmRefNullType(0);
    } catch(e243) {
    }
    let v96;
    try {
        v96 = wasmRefNullType(kWasmNullExternRef);
    } catch(e249) {
    }
    let v98;
    try {
        v98 = wasmRefType(kWasmEqRef);
    } catch(e255) {
    }
    let v102;
    try {
        v102 = wasmRefNullType(kWasmStructRef);
    } catch(e261) {
    }
    ...
    let v106;
    try {
        v106 = wasmRefType(kWasmEqRef);
    } catch(e278) {
    }
    let v108;
    try {
        v108 = wasmRefType(kWasmAnyRef);
    } catch(e284) {
    }
    let v110;
    try {
    ...
    let v123;
    try {
        v123 = wasmRefNullType(kWasmArrayRef);
    } catch(e331) {
    }
    let v125;
    try {
    ...
    let v128;
    try {
        v128 = makeSig(v126, v127);
    } catch(e347) {
    }
    try {
        builder.addType(v128);
    } catch(e349) {
    }
    let v131;
    try {
        v131 = wasmRefType(kWasmExternRef);
    } catch(e355) {
    }
    let v133;
    try {
    ...
    let v134;
    try {
        v134 = wasmRefNullType(kWasmNullFuncRef);
    } catch(e367) {
    }
    ...
    let v137;
    try {
        v137 = makeSig(v135, v136);
    } catch(e376) {
    }
    try {
        builder.addType(v137);
    } catch(e378) {
    }
    try {
    ...
    try {
        builder.addGlobal(kWasmI32, 0, v145);
    } catch(e391) {
    }
    let v149;
    try {
    ...
    try {
        builder.addGlobal(kWasmI32, 0, v149);
    } catch(e400) {
    }
    let v153;
    try {
    ...
    try {
        builder.addGlobal(kWasmI32, 0, v153);
    } catch(e409) {
    }
    let v157;
    try {
    ...
    try {
        builder.addGlobal(kWasmI32, 0, v157);
    } catch(e418) {
    }
    let v161;
    try {
    ...
    try {
        builder.addGlobal(kWasmI32, 0, v161);
    } catch(e427) {
    }
    let v165;
    try {
    ...
    try {
        builder.addGlobal(kWasmI32, 0, v165);
    } catch(e436) {
    }
    let v169;
    try {
    ...
    try {
        builder.addGlobal(kWasmI32, 0, v169);
    } catch(e445) {
    }
    let v173;
    try {
    ...
    try {
        builder.addGlobal(kWasmI32, 0, v173);
    } catch(e454) {
    }
    let v177;
    try {
    ...
    try {
        builder.addGlobal(kWasmI32, 0, v177);
    } catch(e463) {
    }
    let v181;
    try {
    ...
    try {
        builder.addGlobal(kWasmI32, 0, v181);
    } catch(e472) {
    }
    let v185;
    try {
    ...
    try {
        builder.addGlobal(kWasmI32, 0, v185);
    } catch(e481) {
    }
    let v189;
    try {
    ...
    try {
        builder.addGlobal(kWasmI32, 0, v189);
    } catch(e490) {
    }
    let v193;
    try {
    ...
    try {
        builder.addGlobal(kWasmI32, 0, v193);
    } catch(e499) {
    }
    let v197;
    try {
    ...
    try {
        builder.addActiveElementSegment(0, v357, v365, kWasmFuncRef);
    } catch(e873) {
    }
    let v367;
    try {
        v367 = wasmRefType(kWasmExternRef);
    } catch(e879) {
    }
    let v369;
    try {
    ...
    let v370;
    try {
        v370 = wasmRefNullType(kWasmNullFuncRef);
    } catch(e891) {
    }
    ...
    let v880;
    try {
        v880 = wasmRefType(kWasmStructRef);
    } catch(e1416) {
    }
    let v882;
    try {
        v882 = wasmRefNullType(kWasmArrayRef);
    } catch(e1422) {
    }
    let v885;
    try {
    ...
    let v887;
    try {
        v887 = wasmRefType(kWasmExternRef);
    } catch(e1434) {
    }
    let v890;
    try {
        v890 = wasmRefNullType(kWasmI31Ref);
    } catch(e1440) {
    }
    let v893;
    try {
        v893 = wasmRefNullType(9);
    } catch(e1446) {
    }
    let v895;
    try {
        v895 = wasmRefType(kWasmArrayRef);
    } catch(e1452) {
    }
    let v898;
    try {
        v898 = wasmRefNullType(6);
    } catch(e1458) {
    }
    let v902;
    try {
    ...
    let v904;
    try {
        v904 = wasmRefNullType(kWasmI31Ref);
    } catch(e1470) {
    }
    let v908;
    try {
        v908 = builder.addFunction(undefined, 7);
    } catch(e1476) {
    }
    let v909;
    try {
        v909 = v908.addLocals(v904, 1);
    } catch(e1481) {
    }
    let v910;
    try {
        v910 = v909.addLocals(v902, 1);
    } catch(e1486) {
    }
    let v911;
    try {
        v911 = v910.addLocals(kWasmI32, 2);
    } catch(e1491) {
    }
    let v912;
    try {
        v912 = v911.addLocals(v898, 1);
    } catch(e1496) {
    }
    let v913;
    try {
        v913 = v912.addLocals(v895, 1);
    } catch(e1501) {
    }
    let v914;
    try {
        v914 = v913.addLocals(v893, 1);
    } catch(e1506) {
    }
    let v915;
    try {
        v915 = v914.addLocals(v890, 1);
    } catch(e1511) {
    }
    let v916;
    try {
        v916 = v915.addLocals(kWasmI32, 1);
    } catch(e1516) {
    }
    let v917;
    try {
        v917 = v916.addLocals(v887, 1);
    } catch(e1521) {
    }
    let v918;
    try {
        v918 = v917.addLocals(v885, 1);
    } catch(e1526) {
    }
    let v919;
    try {
        v919 = v918.addLocals(v882, 1);
    } catch(e1531) {
    }
    let v920;
    try {
        v920 = v919.addLocals(v880, 1);
    } catch(e1536) {
    }
    let v921;
    try {
        v921 = v920.addLocals(kWasmFuncRef, 1);
    } catch(e1541) {
    }
    let v922;
    try {
        v922 = v921.addLocals(v877, 1);
    } catch(e1546) {
    }
    try {
        v922.addBodyWithEnd(v875);
    } catch(e1548) {
    }
    ...
    let v1028;
    try {
        v1028 = builder.addFunction(undefined, 8);
    } catch(e1657) {
    }
    try {
        v1028.addBodyWithEnd(v1025);
    } catch(e1659) {
    }
    const v1035 = [kExprI32Const,165,148,233,233,120,kExprEnd];
    let v1039;
    try {
        v1039 = builder.addFunction(undefined, 9);
    } catch(e1672) {
    }
    let v1040;
    try {
        v1040 = v1039.addLocals(kWasmI32, 4);
    } catch(e1677) {
    }
    try {
        v1040.addBodyWithEnd(v1035);
    } catch(e1679) {
    }
    try {
