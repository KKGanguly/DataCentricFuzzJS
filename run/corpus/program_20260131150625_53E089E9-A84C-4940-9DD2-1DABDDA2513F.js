try {
    ...
    const v3 = d8?.file;
    try {
        v3.execute("v8/test/mjsunit/wasm/wasm-module-builder.js");
    } catch(e6) {
    }
    let v6;
    try {
    ...
    let v10;
    try {
        v10 = wasmRefNullType(kWasmI31Ref);
    } catch(e18) {
    }
    let v13;
    try {
        v13 = makeField(v10, true);
    } catch(e24) {
    }
    let v14;
    try {
        v14 = wasmRefNullType(kWasmI31Ref);
    } catch(e30) {
    }
    let v16;
    try {
        v16 = makeField(v14, true);
    } catch(e36) {
    }
    let v17;
    try {
        v17 = wasmRefNullType(kWasmI31Ref);
    } catch(e42) {
    }
    let v19;
    try {
        v19 = makeField(v17, true);
    } catch(e48) {
    }
    const v20 = [v13,v16,v19];
    try {
        builder.addStruct(v20);
    } catch(e52) {
    }
    let v22;
    try {
        v22 = wasmRefNullType(kWasmI31Ref);
    } catch(e58) {
    }
    let v24;
    try {
        v24 = makeField(v22, true);
    } catch(e64) {
    }
    let v25;
    try {
        v25 = wasmRefNullType(kWasmI31Ref);
    } catch(e70) {
    }
    let v27;
    try {
        v27 = makeField(v25, true);
    } catch(e76) {
    }
    let v28;
    try {
        v28 = wasmRefNullType(kWasmI31Ref);
    } catch(e82) {
    }
    let v30;
    try {
        v30 = makeField(v28, true);
    } catch(e88) {
    }
    let v33;
    try {
        v33 = makeField(kWasmI8, true);
    } catch(e95) {
    }
    let v35;
    try {
        v35 = makeField(kWasmI8, true);
    } catch(e102) {
    }
    let v38;
    try {
        v38 = makeField(kWasmI64, true);
    } catch(e109) {
    }
    ...
    let v44;
    try {
        v44 = makeField(kWasmF32, false);
    } catch(e121) {
    }
    const v45 = [v44];
    try {
        builder.addStruct(v45);
    } catch(e125) {
    }
    let v48;
    try {
        v48 = makeField(kWasmI8, false);
    } catch(e132) {
    }
    let v50;
    try {
        v50 = makeField(kWasmI64, false);
    } catch(e139) {
    }
    let v52;
    try {
        v52 = wasmRefNullType(kWasmNullRef);
    } catch(e145) {
    }
    let v54;
    try {
        v54 = makeField(v52, false);
    } catch(e151) {
    }
    const v55 = [v48,v50,v54];
    try {
        builder.addStruct(v55);
    } catch(e155) {
    }
    try {
    ...
    let v59;
    try {
        v59 = wasmRefNullType(7);
    } catch(e163) {
    }
    try {
        builder.addArray(v59, true);
    } catch(e166) {
    }
    try {
    ...
    let v65;
    try {
        v65 = wasmRefNullType(kWasmI31Ref);
    } catch(e176) {
    }
    try {
        builder.addArray(v65, true);
    } catch(e179) {
    }
    try {
        builder.addArray(kWasmI16, true);
    ...
    let v88;
    try {
        v88 = wasmRefNullType(kWasmNullExternRef);
    } catch(e224) {
    }
    let v91;
    try {
        v91 = wasmRefNullType(kWasmStructRef);
    } catch(e230) {
    }
    let v93;
    try {
        v93 = wasmRefNullType(0);
    } catch(e236) {
    }
    let v95;
    try {
    ...
    let v97;
    try {
        v97 = wasmRefType(kWasmArrayRef);
    } catch(e248) {
    }
    let v98;
    try {
        v98 = wasmRefType(kWasmI31Ref);
    } catch(e254) {
    }
    const v99 = [kWasmEqRef,v84,v86,v88,kWasmF64,kWasmFuncRef,v91,v93,v95,kWasmI32,v97,v98];
    let v100;
    try {
        v100 = makeSig(v80, v99);
    } catch(e263) {
    }
    try {
        builder.addType(v100);
    } catch(e265) {
    }
    const v102 = [];
    const v103 = [];
    let v104;
    try {
        v104 = makeSig(v102, v103);
    } catch(e274) {
    }
    try {
        builder.addType(v104);
    } catch(e276) {
    }
    try {
        builder.startRecGroup();
    ...
    let v109;
    try {
        v109 = makeSig(v107, v108);
    } catch(e287) {
    }
    try {
        builder.addType(v109);
    } catch(e289) {
    }
    try {
        builder.endRecGroup();
    ...
    let v113;
    try {
        v113 = wasmRefType(kWasmExternRef);
    } catch(e297) {
    }
    let v115;
    try {
    ...
    let v127;
    try {
        v127 = wasmRefNullType(kWasmNullExternRef);
    } catch(e341) {
    }
    let v128;
    try {
        v128 = wasmRefNullType(kWasmStructRef);
    } catch(e347) {
    }
    let v130;
    try {
        v130 = wasmRefNullType(0);
    } catch(e353) {
    }
    let v132;
    try {
    ...
    try {
        builder.addActiveElementSegment(0, v147, v157, kWasmFuncRef);
    } catch(e403) {
    }
    const v159 = [];
    const v160 = [];
    ...
    let v463;
    try {
        v463 = wasmRefNullType(kWasmNullExternRef);
    } catch(e721) {
    }
    let v467;
    try {
        v467 = builder.addFunction(undefined, 8);
    } catch(e727) {
    }
    let v468;
    try {
        v468 = v467.addLocals(v463, 5);
    } catch(e732) {
    }
    try {
        v468.addBodyWithEnd(v462);
    } catch(e734) {
    }
    ...
    let v888;
    try {
        v888 = wasmRefType(kWasmArrayRef);
    } catch(e1159) {
    }
    let v891;
    try {
        v891 = wasmRefNullType(2);
    } catch(e1165) {
    }
    let v893;
    try {
        v893 = wasmRefNullType(kWasmArrayRef);
    } catch(e1171) {
    }
    let v896;
    try {
        v896 = wasmRefNullType(kWasmStructRef);
    } catch(e1177) {
    }
    let v900;
    try {
        v900 = wasmRefNullType(11);
    } catch(e1183) {
    }
    let v903;
    try {
        v903 = wasmRefNullType(3);
    } catch(e1189) {
    }
    let v906;
    try {
        v906 = wasmRefNullType(11);
    } catch(e1195) {
    }
    let v908;
    try {
        v908 = wasmRefType(kWasmEqRef);
    } catch(e1200) {
    }
    let v911;
    try {
    ...
    let v914;
    try {
        v914 = wasmRefNullType(3);
    } catch(e1212) {
    }
    let v917;
    try {
        v917 = wasmRefType(kWasmAnyRef);
    } catch(e1218) {
    }
    let v919;
    try {
        v919 = wasmRefType(kWasmFuncRef);
    } catch(e1223) {
    }
    let v922;
    try {
    ...
    let v924;
    try {
        v924 = wasmRefType(kWasmFuncRef);
    } catch(e1234) {
    }
    let v926;
    try {
        v926 = wasmRefNullType(kWasmNullExternRef);
    } catch(e1240) {
    }
    let v933;
    try {
        v933 = builder.addFunction(undefined, 9);
    } catch(e1246) {
    }
    let v934;
    try {
        v934 = v933.addLocals(kWasmEqRef, 1);
    } catch(e1251) {
    }
    let v935;
    try {
        v935 = v934.addLocals(kWasmS128, 1);
    } catch(e1257) {
    }
    let v936;
    try {
        v936 = v935.addLocals(v926, 1);
    } catch(e1262) {
    }
    let v937;
    try {
        v937 = v936.addLocals(v924, 1);
    } catch(e1267) {
    }
    let v938;
    try {
        v938 = v937.addLocals(v922, 1);
    } catch(e1272) {
    }
    let v939;
    try {
        v939 = v938.addLocals(v919, 1);
    } catch(e1277) {
    }
    let v940;
    try {
        v940 = v939.addLocals(v917, 1);
    } catch(e1282) {
    }
    let v941;
    try {
        v941 = v940.addLocals(v914, 1);
    } catch(e1287) {
    }
    let v942;
    try {
        v942 = v941.addLocals(v911, 1);
    } catch(e1292) {
    }
    let v943;
    try {
        v943 = v942.addLocals(v908, 1);
    } catch(e1297) {
    }
    let v944;
    try {
        v944 = v943.addLocals(v906, 1);
    } catch(e1302) {
    }
    let v945;
    try {
        v945 = v944.addLocals(v903, 1);
    } catch(e1307) {
    }
    let v946;
    try {
        v946 = v945.addLocals(v900, 1);
    } catch(e1312) {
    }
    let v947;
    try {
        v947 = v946.addLocals(kWasmI64, 1);
    } catch(e1318) {
    }
    let v948;
    try {
        v948 = v947.addLocals(v896, 1);
    } catch(e1323) {
    }
    let v949;
    try {
        v949 = v948.addLocals(kWasmF32, 1);
    } catch(e1329) {
    }
    let v950;
    try {
        v950 = v949.addLocals(v893, 1);
    } catch(e1334) {
    }
    let v951;
    try {
        v951 = v950.addLocals(v891, 1);
    } catch(e1339) {
    }
    let v952;
    try {
        v952 = v951.addLocals(v888, 1);
    } catch(e1344) {
    }
    try {
        v952.addBodyWithEnd(v887);
    } catch(e1346) {
    }
    const v954 = [kExprEnd];
    let v958;
    try {
        v958 = builder.addFunction(undefined, 10);
    } catch(e1354) {
    }
    let v959;
    try {
        v959 = v958.addLocals(kWasmI32, 22);
    } catch(e1359) {
    }
    try {
        v959.addBodyWithEnd(v954);
    } catch(e1361) {
    }
    const v961 = [kExprEnd];
    let v964;
    try {
        v964 = wasmRefNullType(1);
    } catch(e1369) {
    }
    let v968;
    try {
        v968 = builder.addFunction(undefined, 11);
    } catch(e1375) {
    }
    let v969;
    try {
        v969 = v968.addLocals(v964, 2);
    } catch(e1380) {
    }
    let v970;
    try {
        v970 = v969.addLocals(kWasmI32, 27);
    } catch(e1385) {
    }
    try {
        v970.addBodyWithEnd(v961);
    } catch(e1387) {
    }
    try {
