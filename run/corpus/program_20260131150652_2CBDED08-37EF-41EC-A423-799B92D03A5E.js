try {
    ...
    let v14;
    try {
        v14 = makeField(kWasmAnyRef, false);
    } catch(e26) {
    }
    let v17;
    try {
        v17 = wasmRefType(kWasmI31Ref);
    } catch(e32) {
    }
    let v19;
    try {
        v19 = makeField(v17, false);
    } catch(e38) {
    }
    let v22;
    try {
        v22 = makeField(kWasmI32, false);
    } catch(e45) {
    }
    const v23 = [v11,v14,v19,v22];
    try {
        builder.addStruct(v23);
    } catch(e49) {
    }
    const v25 = [];
    try {
        builder.addStruct(v25);
    } catch(e53) {
    }
    const v27 = [];
    try {
        builder.addStruct(v27);
    } catch(e57) {
    }
    const v29 = [];
    try {
        builder.addStruct(v29);
    } catch(e61) {
    }
    try {
    ...
    try {
        builder.addActiveElementSegment(0, v59, v67, kWasmFuncRef);
    } catch(e132) {
    }
    const v69 = [];
    const v70 = [];
    ...
    let v358;
    try {
        v358 = wasmRefType(kWasmExternRef);
    } catch(e437) {
    }
    let v361;
    try {
        v361 = wasmRefNullType(0);
    } catch(e443) {
    }
    let v364;
    try {
        v364 = wasmRefNullType(2);
    } catch(e449) {
    }
    let v367;
    try {
        v367 = wasmRefType(kWasmArrayRef);
    } catch(e455) {
    }
    let v371;
    try {
    ...
    let v382;
    try {
        v382 = wasmRefNullType(kWasmNullExternRef);
    } catch(e479) {
    }
    let v386;
    try {
        v386 = builder.addFunction(undefined, 6);
    } catch(e485) {
    }
    let v387;
    try {
        v387 = v386.addLocals(v382, 1);
    } catch(e490) {
    }
    let v388;
    try {
        v388 = v387.addLocals(v379, 1);
    } catch(e495) {
    }
    let v389;
    try {
        v389 = v388.addLocals(kWasmF32, 1);
    } catch(e501) {
    }
    let v390;
    try {
        v390 = v389.addLocals(v375, 4);
    } catch(e506) {
    }
    let v391;
    try {
        v391 = v390.addLocals(kWasmI32, 1);
    } catch(e511) {
    }
    let v392;
    try {
        v392 = v391.addLocals(v371, 1);
    } catch(e516) {
    }
    let v393;
    try {
        v393 = v392.addLocals(kWasmI32, 1);
    } catch(e521) {
    }
    let v394;
    try {
        v394 = v393.addLocals(v367, 1);
    } catch(e526) {
    }
    let v395;
    try {
        v395 = v394.addLocals(v364, 1);
    } catch(e531) {
    }
    let v396;
    try {
        v396 = v395.addLocals(v361, 1);
    } catch(e536) {
    }
    let v397;
    try {
        v397 = v396.addLocals(v358, 4);
    } catch(e541) {
    }
    let v398;
    try {
        v398 = v397.addLocals(kWasmI64, 1);
    } catch(e547) {
    }
    let v399;
    try {
        v399 = v398.addLocals(v353, 5);
    } catch(e552) {
    }
    let v400;
    try {
        v400 = v399.addLocals(v350, 1);
    } catch(e557) {
    }
    try {
        v400.addBodyWithEnd(v347);
    } catch(e559) {
    }
    ...
    let v422;
    try {
        v422 = wasmRefNullType(0);
    } catch(e587) {
    }
    let v424;
    try {
        v424 = wasmRefNullType(kWasmNullExternRef);
    } catch(e593) {
    }
    let v427;
    try {
    ...
    let v432;
    try {
        v432 = wasmRefNullType(4);
    } catch(e611) {
    }
    let v437;
    try {
        v437 = wasmRefNullType(1);
    } catch(e617) {
    }
    let v442;
    try {
    ...
    let v444;
    try {
        v444 = wasmRefNullType(kWasmNullExternRef);
    } catch(e629) {
    }
    let v448;
    try {
        v448 = builder.addFunction(undefined, 7);
    } catch(e635) {
    }
    let v449;
    try {
        v449 = v448.addLocals(v444, 1);
    } catch(e640) {
    }
    let v450;
    try {
        v450 = v449.addLocals(v442, 2);
    } catch(e645) {
    }
    let v451;
    try {
        v451 = v450.addLocals(kWasmF64, 1);
    } catch(e651) {
    }
    let v452;
    try {
        v452 = v451.addLocals(kWasmI32, 1);
    } catch(e656) {
    }
    let v453;
    try {
        v453 = v452.addLocals(v437, 1);
    } catch(e661) {
    }
    let v454;
    try {
        v454 = v453.addLocals(kWasmF64, 1);
    } catch(e667) {
    }
    let v455;
    try {
        v455 = v454.addLocals(v432, 1);
    } catch(e672) {
    }
    let v456;
    try {
        v456 = v455.addLocals(v429, 2);
    } catch(e677) {
    }
    let v457;
    try {
        v457 = v456.addLocals(v427, 1);
    } catch(e682) {
    }
    let v458;
    try {
        v458 = v457.addLocals(v424, 1);
    } catch(e687) {
    }
    let v459;
    try {
        v459 = v458.addLocals(v422, 2);
    } catch(e692) {
    }
    let v460;
    try {
        v460 = v459.addLocals(v419, 2);
    } catch(e697) {
    }
    let v461;
    try {
        v461 = v460.addLocals(kWasmI32, 4);
    } catch(e702) {
    }
    try {
        v461.addBodyWithEnd(v416);
    } catch(e704) {
    }
    ...
    let v598;
    try {
        v598 = builder.addFunction(undefined, 8);
    } catch(e844) {
    }
    try {
        v598.addBodyWithEnd(v595);
    } catch(e846) {
    }
    try {
